...
Thus, 482 participants were included in our final analyses.
...
class of variables were corrected. Here, the time_to_visit_ir:time_8
variables were changed from character to numeric variables. The cleaned
mci_amyloid data set contains 487 observations and 6 variables.
...
It was found that 8 participants were not present in both data sets.

In contrast, 474 participants were present in both data sets.
